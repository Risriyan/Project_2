...
const Navbar = () => {
  ...
  return (
    <div className=" navbar bg-base-100 sticky top-0 z-50  dark:bg-slate-900 dark:text-black w-full ">
      <div className="navbar bg-base-100 dark:bg-slate-700 ">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl">RKz</a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <li tabIndex={0} className="dropdown dropdown-hover">
              <a className="cursor-pointer">
                <Link to="/Pilihan">Beranda</Link>
                <svg
              ...
              <ul className="p-2 bg-base-100 dropdown-content shadow rounded-box w-52">
                <li>
                  <Link to="/">Restaurant</Link>
                </li>
                <li>
